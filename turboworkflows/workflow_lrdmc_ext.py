...
logger = getLogger('Turbo-Workflows').getChild('lrdmc-ext')
...
from pyturbo.utils.utility import get_linenum_fort12, pygrep_lineno, get_line_from_file
            ...
            if not os.path.isdir(os.path.join(alat_dir)):
                ...
                for file in self.lrdmc_input_files:
                    if os.path.isfile(file):
                        shutil.copy(os.path.join(file), os.path.join(alat_dir, os.path.basename(file)))
                    else:  # dir
